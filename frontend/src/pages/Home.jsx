...
const Home = () => {
    ...
    const onSubmitHandler=()=>{
        ...
        if(!owner || !repo){
            alert("Please enter valid repo/owner")
        }
  ...
  return (
    <div className='w-full flex justify-center items-center h-screen'>
        <div className='bg-lime-300 opacity-60 rounded p-4 w-3/4 h-1/4 flex justify-between items-center '>
            ...
            <button className='p-3 bg-lime-200 h-14 rounded cursor-pointer font-semibold border border-lime-400 shadow-2xl hover:bg-lime-400'>Get Repo Files</button>
        </div>
    </div>
  )
}
